...
$result = $conn->query('SELECT COUNT(*) AS total FROM tasks WHERE creator = '.$creatorid);
...
<table class="content-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
            <a href="task_details.php?taskId=<?php echo $task['taskid']; ?>" class="detail-button">Detail</a>
            <button class="delete-button" data-taskid="<?php echo $task['taskid']; ?>">Delete</button>
            </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
...
<script>
  $(document).ready(function() {
    ...
    $.post('../server/delete_task.php', { taskId: taskId }, function(response) {
        if (response.success) {
            location.reload();
        } else {
