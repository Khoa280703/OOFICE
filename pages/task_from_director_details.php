...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO taskresults (taskid, result, revision, creator, time, status) VALUES (?, ?, ?, ?, NOW(), ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('issss', $taskId, $result, $revision, $creator, $status);
    $stmt->execute();
}
?>
<!DOCTYPE html>
...
<form method="POST" enctype="multipart/form-data" class="result-form">
